...
В качестве третьего конфликта слияния предположим, что здесь наш второй сотрудник создал часть кода, которую было решено не вносить в рабочую версию сайта (или программы и т.п.).